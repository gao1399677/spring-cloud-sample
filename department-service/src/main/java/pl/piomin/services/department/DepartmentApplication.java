...
public class DepartmentApplication {
	...
	DepartmentRepository repository() {
		...
		repository.add(new Department(1L, "Development2"));
		repository.add(new Department(1L, "Development3"));
		repository.add(new Department(1L, "Development4"));
		repository.add(new Department(1L, "Development5"));
